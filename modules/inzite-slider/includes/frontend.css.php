...
FLBuilderCSS::typography_field_rule(array(
	...
	'selector' 	=> ".fl-node-" . $id . " .inzite-card__heading-text",
));

FLBuilderCSS::typography_field_rule(array(
	'settings'	=> $settings,
	'setting_name' 	=> 'content_typography',
	'selector' 	=> ".fl-node-" . $id . " .inzite-card__content-text",
));

FLBuilderCSS::typography_field_rule(array(
	'settings'	=> $settings,
	'setting_name' 	=> 'link_typography',
	'selector' 	=> ".fl-node-" . $id . " .inzite-card__link",
));

FLBuilderCSS::border_field_rule(array(
	'settings' 	=> $settings,
	'setting_name' 	=> 'background_border',
	'selector' 	=> ".fl-node-" . $id . " .fl-inzite-card",
));
...
.fl-node-<?php echo $id; ?> .horizontal .inzite-card__image{
width: <?php echo $settings->image_width; ?><?php echo $settings->image_width_unit; ?>;
}

.fl-node-<?php echo $id; ?> .inzite-card__link-container.content_align {
...
<?php echo ".fl-node-" . $id . " " . $settings->heading_tag; ?>.inzite-card__heading-text {
...
.fl-node-<?php echo $id; ?> .inzite-card__content {
...
.fl-node-<?php echo $id; ?> .inzite-card__link {
...
.fl-node-<?php echo $id; ?> .inzite-card__image {
