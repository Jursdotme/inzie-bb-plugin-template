<div class="mt-12 grid gap-5 max-w-none mx-auto md:grid-cols-2 lg:grid-cols-4 w-full">
	...
	if ($query->have_posts()) {
		while ($query->have_posts()) {
			...
			<div class="flex flex-col rounded-lg shadow-lg border-solid border border-inzite-light-blue overflow-hidden">
				<div class="flex-1 bg-white p-6 flex flex-col justify-between">
					...
					<a href="<?php the_permalink(); ?>" class="flex items-center justify-end">
						...
						<span class="w-6 h-6 bg-inzite-light-blue rounded-full text-white p-1">
		...
		?>
		<div class="flex flex-col rounded-lg shadow-lg border-solid border border-inzite-light-blue overflow-hidden col-span-2">
			<div class="flex-1 bg-white p-6 flex flex-col justify-between">
				No products
			</div>
		</div>
